...
function cami_scripts()
{
	...
	wp_enqueue_script('cami-bs-util', get_template_directory_uri() . '/js/util.js', array('jquery'), '20151215', true);
	wp_enqueue_script('cami-bs-collapse', get_template_directory_uri() . '/js/collapse.js', array('jquery'), '20151215', true);
